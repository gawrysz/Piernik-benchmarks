...
fig_lab_pos = (0.5, 0.8)  # (0.5, 0.1) for bottom placement
...
def mkrplot(rdata):
    ...
    plt.annotate("Piernik benchmarks: Ryzen 7 2700 @ 4000 MHz (OC), RAM 3000 MHz", xy=(0.5, 0.97), xycoords="figure fraction", horizontalalignment='center', size=20)

    plt.savefig("transposition_speedup.png")
    plt.show()
